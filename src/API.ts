...
export type ModelQuoteAppDataConditionInput = {
  ...
  qutoesGenerated?: ModelIntInput | null,
...
export type ModelSubscriptionQuoteAppDataFilterInput = {
  ...
  qutoesGenerated?: ModelSubscriptionIntInput | null,
...
export type GenerateQuoteQueryVariables = {
  input: string,
};

export type GenerateQuoteQuery = {
  generateQuote?: string | null,
};
